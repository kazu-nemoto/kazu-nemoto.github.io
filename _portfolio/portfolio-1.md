...
- 公開先: https://medium.com/@nimotougou/日本語訳-a-vision-of-metascience-an-engine-of-improvement-for-the-social-processes-of-science-89ddd3629a98

原著はメタサイエンス（科学の社会的プロセスを改善する提案）に関する重要な議論を含んでおり、研究評価や再現性、研究コミュニティの制度設計に関心のある方にとって示唆の多い内容です。

翻訳は個人的な学習および情報共有の目的で行いました。誤訳や分かりにくい表現があればぜひご指摘ください。コメントや共有は歓迎します。

---

Published a Japanese translation — "A Vision of Metascience"
...
This translation was done for personal learning and sharing. Please let me know if you find any mistranslations or unclear expressions. Comments and shares are welcome.

---

（表示をさらにフォーマルにしたい、または `tags`, `date`, `author` をフロントマターに追加してほしい場合は教えてください）
